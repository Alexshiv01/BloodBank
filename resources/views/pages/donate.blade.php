    ...
    <div class="container size">
        <div class="row">
            <div class="col-md-6 offset-md-3 form-container">
                ...
                @endif
                <form class="form-group" action="  {{ route('donors.store') }}" method="post"
                    ...
                    <div class="form-inline">
                        ...
                        <input  class="form-control demo-default" id="date" name="dob" type="date" style="margin-bottom:10px;">
                        {{-- <select class="form-control demo-default" id="date" name="dob" style="margin-bottom:10px;"
                            required>
                        ...
                        <select class="form-control demo-default" id="year" name="year"
                    ...
                    <div class="form-group">
                        ...
                        <select name="city" id="city" class="form-control demo-default" required>
                            ...
                            <option value="Bagh">Bhairahawa</option>
                            <option value="Bhimber">Butwal</option>
                            <option value="Kotli">Lumbini</option>
                            <option value="Mirpur">Parasi</option>
                            <optgroup title="Nawalparasi (Province Lumbini)"
                                label="&raquo;Nawalparasi (Province Lumbini) "></optgroup>
